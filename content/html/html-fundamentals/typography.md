...
toc: true
type: docs
date: "2020-08-18T00:00:00+01:00"
draft: false
menu:
  html-fundamentals:
    parent: HTML
...
`<em>` tags - normally - used on single words, maybe two, but we can sometimes use it on the whole sentence
...
`<i>` element - used semantically to convey text in an alternative voice or tone. (No added emphasis or importance.) 
...
`<b>` element - used solely to change the presentation of an element.
...
As here em is a child of a strong element, its text will be both italicized and bold.
<strong>Do not approach the electrified fence <em>under any circumstances.</em> </strong> 

You can style any text as bold or italic with CSS, as well as override the browser’s default styling of elements like strong and em. 
...
`<ins>` element – to draw attention to text that has been inserted since a previous version of the document. 

`<u>` element – to underline text for presentation purposes. 

<div class="alert alert-note">
  <div>
    <p style="text-align:center;"> A Caveat! </p>
...
The del element is used to identify text deleted or removed from the document. <br>
The s element identifies text that is no longer accurate or relevant (for presentation purposes).
