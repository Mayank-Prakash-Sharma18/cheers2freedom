...
linktitle: Linking site with Google Search Console
toc: true
type: docs
...
Just login with Gmail account to <a href="https://search.google.com/search-console" target="_blank" title="Google Search Console / Google Webmaster">Google Search Console</a>. 
...
<img src="../../../media/seo/technical-seo/google-search-console1.png" alt="linking google search console with website" style="width:81%;height:81%;">

Now press ‘Continue’ and get the code from Google console. 
<img src="../../../media/seo/technical-seo/google-search-console2.png" alt="linking google search console with website" style="width:72%;height:72%;">
...
<img src="../../../media/seo/technical-seo/google-search-console3.png" alt="linking google search console with website" style="width:63%;height:63%;">

Now go back to Google Search Console and click Verify:
<img src="../../../media/seo/technical-seo/google-search-console4.png" alt="linking google search console with website" style="width:63%;height:63%;">
Congratulations! You have verified the ownership of your website in Google Search Console. 

<br><hr><br>

Now, let us explore some other options of verifying your website ownership too. You may skip the rest of the article if you want to. We will just have a look at the other available options. 

## URL prefix property type

Give full URL of your site, i.e. with https and www. (in Domain property type we do not use https and www)
<img src="../../../media/seo/technical-seo/google-search-console5.png" alt="linking google search console with website" style="width:45%;height:45%;">
...
### Meta tag method 
<img src="../../../media/seo/technical-seo/google-search-console6.png" alt="linking google search console with website" style="width:72%;height:72%;">
...
Paste the code inside the ```<head>``` tags. 
<img src="../../../media/seo/technical-seo/google-search-console7.png" alt="linking google search console with website" style="width:99%;height:99%;">
Update the file, go back to Google console and click Verify button. 
<img src="../../../media/seo/technical-seo/google-search-console8.png" alt="linking google search console with website" style="width:63%;height:63%;">
...
### HTML file method 
<img src="../../../media/seo/technical-seo/google-search-console9.png" alt="linking google search console with website" style="width:72%;height:72%;">

In this verification method, we need to upload the HTML file downloaded from Google Search Console to our website.

In case of WordPress, go to File Manager of your Hosting account and upload the HTML file in the root folder of the respective domain/subdomain.
<img src="../../../media/seo/technical-seo/google-search-console10.png" alt="linking google search console with website" style="width:72%;height:72%;">

Now, go back to Google console and click Verify button.
<img src="../../../media/seo/technical-seo/google-search-console11.png" alt="linking google search console with website" style="width:63%;height:63%;">

So, you can use these verification methods to verify the ownership of your site in Google Console. The method you choose will depend on the kind of website you have and your personal choice. 
