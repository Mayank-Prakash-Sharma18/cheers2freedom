...
HTML कोई प्रोग्रामिंग भाषा (programming language) नहीं है। यह बस एक ऐसी भाषा है जिसे ब्राउज़र समझ सकते हैं! <br>
...
element के नाम के बाद, ***प्रारंभिक tag के भीतर*** ही attributes को परिभाषित किया जाता है। 
...
सबसे आम attributes निम्नलिखित हैं:
...
* दस्तावेज़ के शीर्ष की पहचान करता है। इसमें HTML पृष्ठ के बारे में ***मेटा जानकारी*** (meta information) शामिल होती है।
